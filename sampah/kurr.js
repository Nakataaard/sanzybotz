...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© NahBotz v.9.0_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `Nakata v.3.0`, "footerText": "*_© NahBotz v.9.0_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© NahBotz v.9.0_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
${prefix}othermenu_
 `
sendButLocation(from, `${menu}`, "*_© NahBotzゑ v.9.0_*", {jpegThumbnail:ofrply2,name:""}, [{buttonId:`store`,buttonText:{displayText:'STORE BOT'},type:1},{buttonId:`command`,buttonText:{displayText:'LIST MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
...
${prefix}bc [ _teks/reply gif/image/video with caption_ ]_
${prefix}tobc [ _reply sticker/audio with caption_ ]_
...
${prefix}upswaudio [ _reply audio_ ]_
...
${prefix}setprefix [ _multi/nopref/prefix_ ]_
${prefix}setbio [ _teks_ ]_
${prefix}leave_
${prefix}restart_
${prefix}addrespon [ _tanya|jawab_ ]_
${prefix}delrespon [ _nama_ ]_
${prefix}listrespon_
${prefix}readall_
${prefix}unreadall_
${prefix}archive_
${prefix}unarchiveall_
${prefix}pin_
${prefix}unpin_
${prefix}setmenu [ _ori/simpel_ ]_
${prefix}setallmenu [ _ori/simpel_ ]_
${prefix}leavetime [ _detik/menit/jam_ ]_
${prefix}bukatime [ _detik/menit/jam_ ]_
${prefix}tutuptime [ _detik/menit/jam_ ]_
${prefix}nano [ _nama file_ ]_             
 `
sendButLocation(from, `${menu}`, "*_© NahBotzゑ v.9.0_*", {jpegThumbnail:ofrply1,name:""}, [{buttonId:`menu`,buttonText:{displayText:'BACK TO MENU'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
else if(menusimpel = true){
        stod = `${sender}`
fill =`Hai Kak ${pushname}, ${tampilUcapan}
...
case 'makermenu':
  if (!isRegistered) return reply(`daftar dlu om ketik .verify`)
     ...
     get_result = ini_result.result
       ...
       menu = `*─❒ MAKER MENU*
${prefix}terbaikmaker (teks/teks2)_
${prefix}bengekmaker (teks/teks2)_
${prefix}memekertas (teks)_
${prefix}shadow (teks)_
${prefix}banner (teks)_
${prefix}flaming (teks)_
${prefix}rainbow (teks)_
${prefix}smoke (teks)_
${prefix}love (teks)_
${prefix}wood (teks)_
${prefix}stars (teks)_
${prefix}coffee (teks)_
${prefix}butterfly (teks)_
${prefix}summer (teks)_
${prefix}candy (teks)_
${prefix}royal (teks)_
${prefix}paper (teks)_
${prefix}fur (teks)_
${prefix}joker (teks)_
${prefix}blackpink (teks)_
${prefix}neon (teks)_
${prefix}devil (teks)_
${prefix}matrix (teks)_
${prefix}transformers (teks)_
${prefix}thunder (teks)_
${prefix}harry (teks)_
...
${prefix}animefeets_
${prefix}animebooty_
${prefix}animethighss_
${prefix}hentaiparadise_
${prefix}animearmpits_
${prefix}hentaifemdom_
${prefix}lewdanimegirls_
${prefix}biganimetiddies_
${prefix}animebellybutton_
${prefix}hentai4everyone_
${prefix}bj_
${prefix}ero_
${prefix}cum_
${prefix}feet_
...
"templateMessage": {
						"hydratedTemplate": {
							...
							"hydratedFooterText": `Nakata v.9.0`,
							"hydratedButtons": [
								{
									"quickreplyButton": {
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdreply:{title: "Developer Nakata Ardinata",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./logonya.jpeg'),sourceUrl:"https://wa.me/p/6349482305092740/6281220670449"}}})
	}
    }
    }
    }
